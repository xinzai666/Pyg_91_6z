...
public class SellerController {
	...
	@RequestMapping("/updateAuditStatus/{status}/{sellerId}")
	public Result updateAuditStatus(@PathVariable("status") String status, @PathVariable("sellerId")String sellerId){
		try {
			sellerService.updateAuditStatus(status, sellerId);
